...
public class Equipment implements Item {
    ...
    @Override public String getTooltip() { return tooltip == null ? null : tooltip.toString(); }
    @Override public ItemType getType() { return itemType; }
    @Override public EquipmentSlot getSlot() { return equipmentSlot; }
        @Override public void setSlot(EquipmentSlot slot) { this.equipmentSlot = slot; }

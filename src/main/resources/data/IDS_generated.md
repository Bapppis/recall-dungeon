...
>>>>>>> ac5db2c (- Added variables that property can affect: staminaRegen, crit, dodge, block, magicResist, maxHp, maxStamina, maxMana (also added so hp, stamina and mana can be cut or multiplied with percentages))
